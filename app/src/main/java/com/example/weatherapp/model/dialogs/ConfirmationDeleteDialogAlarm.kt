...
import com.example.weatherapp.ui.alerts.OnDeleteAlarmDialog

class ConfirmationDeleteDialogAlarm(private val onOkClickListener: OnDeleteAlarmDialog, val alarm: DateDtoForRoom): DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ok.setOnClickListener{
                onOkClickListener.deleteClick(alarm)
                dismiss()
            }
